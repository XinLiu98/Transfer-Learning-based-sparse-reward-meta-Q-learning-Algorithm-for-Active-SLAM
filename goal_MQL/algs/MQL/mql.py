...
class MQL:
    ...
    def select_action(self, obs, previous_action, previous_reward, previous_obs):
        ...
        #print('mql140',previous_action.shape, previous_obs.shape, previous_reward.shape)
    ...
    def do_training(self,
        ...
        print('------do training------iteration:',iterations)
    ...
    def train_TD3(
        ...
        #    if temp < iterations:
        #        iterations = temp
        print('------train_TD3------iterations:',iterations)
