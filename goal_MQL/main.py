...
parser.add_argument('--check_point_dir', default='./ck/4-d1/mql')
...
parser.add_argument('--max_path_length', type=int, default = 400)#200) #todo 4
...
if __name__ == "__main__":
    ...
    loggerr = SummaryWriter(log_dir="data/444-d1/mql")
